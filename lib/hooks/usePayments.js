...
export function usePayments(patientId) {
  ...
  group_start_date: p.group_start_date ?? null,
  ...
  autofac_folio: p.autofac_folio ?? String(p.id),
  autofac_status: p.autofac_status ?? null,
  paciente_nombre: p.paciente_nombre ?? null,
  paciente_apellidos: p.paciente_apellidos ?? null,
  notas: p.notas,
